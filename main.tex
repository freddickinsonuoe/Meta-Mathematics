...
This paper examines the validity of Cardano's Method by comparing its results to mathematical software Maple and Mathematica. Indeed, depending on the definition of the cube root used, Cardano's Method can produce an answer equivalent to the one of the software. For example, when Cardano's Method is applied to a reduced cubic of the form $y^3 + 3py - 2q = 0$, the procedure goes as follows:
