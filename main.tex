...
The determinant of a cubic is associated to the determinant of its quadratic derivative. Indeed, firstly let us express $\Delta$ in a way that will highlight the discriminant of a quadratic. We have 
$$\Delta = \frac{1}{27 a^2} (4(b^2-3ac)^3 - (27a^2d+2b^3-9abc)^2)$$
\textbf{Proof} We have
\begin{align*}
    \Delta &= \frac{1}{27a^2}(27a^2b^2c^2-108a^3c^3-108a^2b^3d + 486a^3bcd-729a^4d^2) \\ 
    &= \frac{1}{27a^2} ((108a^2b^2c^2-108a^3c^3-36ab^4c+4b^6)-(729a^4d^2-486a^3bcd+108a^2b^3d \\ &+81a^2b^2c^2-36ab^4c+4b^6)) \\
    &= \frac{1}{27a^2} (4(27a^2b^2c^2-27a^3c^3-9ab^4c+b^6)-(729a^4d^2-486a^3bcd+108a^2b^3d \\
    &+81a^2b^2c^2-36ab^4c+4b^6)) \\
    &= \frac{1}{27a^2}(4(b^2-3ac)^3-(27a^2d+2b^3-9abc)^2)
\end{align*}
Applying the quadratic determinant formula to the derivative of a cubic as defined, we obtain $\Delta_2 = (2b)^2 - 4(3a)c = 4(b^2-3ac)$. It is easy to see how this formula is highlighted in the new expression of the cubic determinant. Assuming $a,b,c,d$ are all real, we have $(27a^2d+2b^3-9abc)^2 \geq 0$. Thus,
\begin{align*}
    \Delta &\leq \frac{4}{27a^2}(b^2-3ac)^3 \\
    27a^2 \Delta &\leq 4(b^2-3ac)^3 \\
